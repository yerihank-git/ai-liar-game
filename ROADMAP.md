...
| 항목 | 상태 |
|------|------|
| 전체 진행률 | Phase 0 — PRD 작성 완료 |
| 현재 Phase | 개발 착수 전 |
| 다음 마일스톤 | M1 - 프로젝트 초기 설정 완료 |
| PRD 완료일 | 2026-03-13 |
...
| M1: 프로젝트 초기 설정 + DB | 2026-03-20 | Next.js + Supabase 6테이블 + 홈 페이지 + 방 생성 API | 예정 |
| M2: 대기실 + 실시간 동기화 | 2026-03-27 | 대기실 UI, Realtime 플레이어 동기화, 게임 설정 | 예정 |
| M3: 게임 플레이 완성 (AI 미포함) | 2026-04-03 | 역할 배정 → 설명 → 투표 → 결과 전체 흐름 | 예정 |
| M4: AI 플레이어 연동 완성 | 2026-04-10 | Claude API 5개 엔드포인트, AI 플레이어 전체 참여 | 예정 |
| M5: 완성도 + 테스트 | 2026-04-17 | 토론 채팅, 타이머, 반응형, 에러 처리, 단위 테스트 | 예정 |
| M6: 프로덕션 배포 | 2026-04-24 | Vercel 배포, CI/CD, README, CLAUDE.md | 예정 |
