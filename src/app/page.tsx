  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse, rgba(230,57,70,0.35) 0%, transparent 70%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse, rgba(6,214,160,0.3) 0%, transparent 70%)",
        }}
      />
      <svg
        className="absolute top-0 right-0 opacity-[0.04] w-72 h-72"
        viewBox="0 0 200 200"
      >
        {[0, 40, 80].map((o) => (
          <line
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, transparent 10%, rgba(230,57,70,0.2) 50%, transparent 90%)",
        }}
      />
      <div
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            color: question ? "rgba(255,255,255,0.08)" : color,
        ...
        <div className="text-center px-2 space-y-0.5">
          <p
            ...
            style={{ color, fontFamily: "var(--font-game-mono)" }}
          >
            {label}
          </p>
          <p
        ...
        <div
          className="absolute bottom-2 right-2.5 text-[9px] opacity-15"
          style={{ fontFamily: "var(--font-game-mono)", color }}
        >
          {question ? "??" : "01"}
        </div>
      </div>
...
/* ── 히어로 섹션 ─────────────────────────────────────── */
function HeroSection({ joinCode }: { joinCode?: string }) {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pb-32 overflow-hidden scanline-overlay">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl mx-auto gap-7">
        ...
        <div className="game-float-in" style={{ animationDelay: "120ms" }}>
          <p
            className="text-xs tracking-[0.5em] uppercase mb-1 opacity-30"
            style={{ fontFamily: "var(--font-game-mono)" }}
          >
            WHO IS THE
          </p>
        ...
        {/* CTA */}
        <div
          className="game-float-in flex flex-col sm:flex-row gap-3"
        ...
        <p
          className="game-float-in text-[10px] tracking-[0.35em] opacity-20 uppercase"
          style={{
  ...
  const features = [
    {
      ...
      title: "링크로 즉시 시작",
      desc: "회원가입 없이 닉네임만으로. 생성된 링크를 공유하면 게임 시작.",
      accent: "#f4a261",
    },
    {
      num: "02",
      ...
      title: "AI가 빈자리를 채운다",
      desc: "인원 부족해도 OK. AI가 시민·라이어·바보 역할로 실제 참여.",
      accent: "#06d6a0",
    },
    {
      num: "03",
      ...
      title: "AI 사후 분석",
      desc: "게임 종료 후 핵심 단서, 의심 포인트, 전략을 해설해준다.",
      accent: "#e63946",
    },
  ];
        ...
        {features.map((f) => (
          ...
          >
            ...
            <div className="flex items-start justify-between">
              ...
              <span
                className="text-[10px] opacity-18"
                style={{ fontFamily: "var(--font-game-mono)" }}
              >
                {f.num}
              </span>
...
function ModeCard({
  ...
  color: string;
  steps: [string, string][];
  outcomes: { label: string; sub: string; color: string }[];
}) {
  return (
    <div
    ...
    >
      <div
        className="absolute top-3 right-4 opacity-[0.04] pointer-events-none"
        style={{
          fontFamily: "var(--font-bebas)",
          fontSize: "7rem",
          lineHeight: 1,
      ...
      <div>
        <span
          className="inline-block text-[10px] px-2 py-0.5 rounded tracking-widest uppercase mb-2"
          style={{
            background: `${color}15`,
            color,
            fontFamily: "var(--font-game-mono)",
      ...
      <ol className="space-y-2.5">
        {steps.map(([step, desc], i) => (
          <li key={i} className="flex items-start gap-3">
            <span
              className="flex-shrink-0 w-5 h-5 rounded flex items-center justify-center text-[10px] mt-0.5"
              style={{
                background: `${color}15`,
                color,
                fontFamily: "var(--font-game-mono)",
  ...
  return (
    <section className="relative px-6 py-28 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-lg mx-auto space-y-6">
        ...
        >
          지금 바로 <span style={{ color: "var(--liar-red)" }}>시작</span>
          하겠습니까?
        </h2>
        <p
  ...
  return (
    <div className="flex items-center gap-4">
      <div
        ...
        style={{
          background:
            "linear-gradient(to right, transparent, rgba(230,57,70,0.3))",
        }}
      />
      <p
        className="text-[10px] tracking-[0.4em] uppercase opacity-25"
        style={{ fontFamily: "var(--font-game-mono)" }}
      >
        {label}
      </p>
      <div
        ...
        style={{
          background:
            "linear-gradient(to left, transparent, rgba(230,57,70,0.3))",
        }}
      />
    </div>
  );
